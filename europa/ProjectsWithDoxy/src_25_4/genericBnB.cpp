...
int main() {
	...
	BnB_UP<City> bnbCity(citiesV,&City::getMaxPossibleTravelTimeSpent,&City::getPreference );
	vector<City*> sol1 = bnbCity.findSolution(11);
	...
	*/
	...
	BnB_UP<City> bnbCity2(citiesV3,&City::getMaxPossibleTravelTimeSpent,&City::getPreference );
	vector<City*> sol2;
	//sol2 = bnbCity2.findSolution(65);
	sol2 = bnbCity2.problem8ApproximateSolve(&citiesV3[8],&City::getMaxPossibleTravelTimeSpentOnStart,75);
	cout<<"debug2:\n";
	...
	BnB_UP<City> bnbCity4(citiesV4,&City::getMaxPossibleTravelTimeSpent,&City::getPreference );
	vector<City*> sol4 = bnbCity4.findSolution(16);
	cout<<"debug4:\n";
