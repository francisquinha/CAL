...
void GreedyApproxTSP(vector<vector<double> > adjacency, vector<unsigned int> &tsp, double &tsp_cost) {
...
void GreedyApproxVRP(vector<vector<double> > adjacency, vector<double> preference, double limit, vector<unsigned int> &vrp, double &vrp_gain, double &vrp_cost) {
    unsigned int number_cities = static_cast<int>(adjacency.size());
    unsigned int current_city = 0;
